...
MapPage *SimpleMapPageFactory::createMapPage(MainWindow * mainWindow)
{
    ...
    mapPage->addMapResult( new IntRangedMapResult(mapPage,QObject::tr("Degré des places"),mainWindow->histoIntData[0],0,2,5,1,0) );
    mapPage->addMapResult( new IntRangedMapResult(mapPage,QObject::tr("Degré second des places"),mainWindow->histoIntData[1],1,2,10,2,0) );
    mapPage->addMapResult( new IntRangedMapResult(mapPage,QObject::tr("Degré troisième des places"),mainWindow->histoIntData[2],2,10,20,2,0) );
    mapPage->addMapResult( new DoubleMapResult(mapPage,QObject::tr("Accessibilité des voies"),mainWindow->histoDoubleData[1],3,1));
    mapPage->addMapResult( new IntRangedMapResult(mapPage,QObject::tr("Degré des voies"),mainWindow->histoIntData[3],4,2,15,4,1));
    ...
    mapPage->addMapResult( new IntRangedMapResult(mapPage,QObject::tr("Longueur topologique des voies"),mainWindow->histoIntData[4],8,1,10,2,1));
